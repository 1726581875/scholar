...
import cn.scholar.common.pojo.UserLoginInfo;
import cn.scholar.common.utils.CookieUtil;
import cn.scholar.common.utils.JwtUtil;
...
import cn.scholar.service.LoginService;
...
public class UserLoginController {
    ...
    @Autowired
   private LoginService userServiceImpl;


    @PostMapping("/login")
    public Object login(String inputStr,String password, HttpServletResponse resp) {
        //1.校验参数 。。 略
         log.info("[用户登录位服务] inputStr={} , password={}",inputStr,password);
